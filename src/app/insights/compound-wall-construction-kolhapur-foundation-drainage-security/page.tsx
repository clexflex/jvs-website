...
const slug = "compound-wall-construction-kolhapur-foundation-drainage-security";
const insight = getInsightBySlug(slug);

if (!insight) {
  throw new Error(`Missing insight data for slug: compound-wall-construction-kolhapur-foundation-drainage-security`);
}
