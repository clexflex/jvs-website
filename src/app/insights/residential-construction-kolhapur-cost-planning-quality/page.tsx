...
const slug = "residential-construction-kolhapur-cost-planning-quality";
const insight = getInsightBySlug(slug);

if (!insight) {
  throw new Error(`Missing insight data for slug: residential-construction-kolhapur-cost-planning-quality`);
}
