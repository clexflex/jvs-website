...
const slug = "dy-patil-hospital-kadamwadi-compound-wall-project-note";
const insight = getInsightBySlug(slug);

if (!insight) {
  throw new Error(`Missing insight data for slug: dy-patil-hospital-kadamwadi-compound-wall-project-note`);
}
