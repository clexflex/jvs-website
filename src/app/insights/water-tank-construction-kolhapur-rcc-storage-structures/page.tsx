...
const slug = "water-tank-construction-kolhapur-rcc-storage-structures";
const insight = getInsightBySlug(slug);

if (!insight) {
  throw new Error(`Missing insight data for slug: water-tank-construction-kolhapur-rcc-storage-structures`);
}
