...
const slug = "rcc-work-kolhapur-columns-beams-slabs-quality-guide";
const insight = getInsightBySlug(slug);

if (!insight) {
  throw new Error(`Missing insight data for slug: rcc-work-kolhapur-columns-beams-slabs-quality-guide`);
}
