...
const slug = "institutional-construction-kolhapur-colleges-hospitals-campuses";
const insight = getInsightBySlug(slug);

if (!insight) {
  throw new Error(`Missing insight data for slug: institutional-construction-kolhapur-colleges-hospitals-campuses`);
}
