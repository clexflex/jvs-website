...
const slug = "construction-project-planning-site-assessment-handover";
const insight = getInsightBySlug(slug);

if (!insight) {
  throw new Error(`Missing insight data for slug: construction-project-planning-site-assessment-handover`);
}
