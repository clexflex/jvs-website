...
const slug = "turnkey-construction-projects-kolhapur-single-responsible-contractor";
const insight = getInsightBySlug(slug);

if (!insight) {
  throw new Error(`Missing insight data for slug: turnkey-construction-projects-kolhapur-single-responsible-contractor`);
}
