...
const slug = "construction-budgeting-boq-estimation-cost-overruns-kolhapur";
const insight = getInsightBySlug(slug);

if (!insight) {
  throw new Error(`Missing insight data for slug: construction-budgeting-boq-estimation-cost-overruns-kolhapur`);
}
