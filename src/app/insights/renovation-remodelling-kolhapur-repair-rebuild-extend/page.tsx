...
const slug = "renovation-remodelling-kolhapur-repair-rebuild-extend";
const insight = getInsightBySlug(slug);

if (!insight) {
  throw new Error(`Missing insight data for slug: renovation-remodelling-kolhapur-repair-rebuild-extend`);
}
