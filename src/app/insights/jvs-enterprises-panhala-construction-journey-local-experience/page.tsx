...
const slug = "jvs-enterprises-panhala-construction-journey-local-experience";
const insight = getInsightBySlug(slug);

if (!insight) {
  throw new Error(`Missing insight data for slug: jvs-enterprises-panhala-construction-journey-local-experience`);
}
