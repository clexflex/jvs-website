...
const slug = "sports-ground-external-development-work-kolhapur";
const insight = getInsightBySlug(slug);

if (!insight) {
  throw new Error(`Missing insight data for slug: sports-ground-external-development-work-kolhapur`);
}
