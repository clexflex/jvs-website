...
const slug = "commercial-construction-kolhapur-business-buildings";
const insight = getInsightBySlug(slug);

if (!insight) {
  throw new Error(`Missing insight data for slug: commercial-construction-kolhapur-business-buildings`);
}
