export const siteConfig = {
  ...
  locationLine: "Panhala · Kolhapur · Since 2006",
  phone: "+91 98609 43500",
  alternatePhone: "+91 90492 43110",
  email: "jvs243110@gmail.com",
  gstin: "27CJXPB7834H1ZO",
  address:
    "Ward No. 1, Shing Galli, Near S.T. Stand, Panhala, Tal. Panhala, Dist. Kolhapur, Maharashtra 416201",
  shortAddress: "Shing Galli, Near S.T. Stand, Panhala, Kolhapur 416201",
  whatsappMessage:
...
export const stats = [
  ...
  { label: "Approx. Turnover", value: "₹10 Cr+" },
  { label: "Project Experience", value: "Panhala & Kolhapur" },
];
...
export const services = [
  {
    id: "planning",
    navLabel: "Planning",
    eyebrow: "01 · PLANNING & PRE-CONSTRUCTION",
    title: "Planning & Pre-Construction",
    heading: "Start with clarity before work begins on site.",
    summary:
    ...
    body:
      "A construction project becomes easier to control when the early decisions are clear. Before excavation, foundation, RCC, and finishing begin, the site must be understood, drawings must be coordinated, quantities must be reviewed, and the estimated cost must be planned practically. JVS Enterprises supports clients during the planning stage so the project begins with better clarity on scope, budget, schedule, and site requirements.",
    included: [
  ...
  },
  {
    ...
    eyebrow: "02 · BUILDING CONSTRUCTION",
    ...
    body:
      "JVS Enterprises undertakes construction work for residential, commercial, institutional, and industrial-use buildings. The company can support clients through structural construction, masonry, finishing coordination, external works, and practical site management. Whether the project is a single home, a farmhouse, a college building, a commercial structure, or a turnkey requirement, the focus remains the same: planned execution, supervised work, and dependable progress.",
    included: [
    ...
    cta: "View Building Projects",
  },
  {
    id: "rcc-works",
    navLabel: "RCC Works",
    eyebrow: "03 · RCC & STRUCTURAL WORKS",
    title: "Structural & RCC Works",
    heading: "The strength of a building begins with its structure.",
    summary:
    ...
    body:
      "RCC work is one of the most important parts of any construction project. Columns, beams, slabs, staircases, foundations, water tanks, and compound walls must be executed with proper alignment, shuttering, steel placement, concrete work, curing, and supervision. JVS Enterprises undertakes structural and RCC works for residential, institutional, commercial, and external development requirements.",
    included: [
      "Foundation work",
      "RCC columns",
      "RCC beams",
    ...
    cta: "Discuss RCC Work",
  },
  {
    id: "finishing",
    navLabel: "Finishing",
    eyebrow: "04 · FINISHING & COORDINATION",
    title: "Finishing & Interior Coordination",
    heading: "Finishing work should support both appearance and use.",
    summary:
    ...
    body:
      "A building is experienced through its finishing. Flooring, tiling, painting, waterproofing, doors, windows, ceiling work, plumbing, and electrical coordination all affect the comfort, usability, and maintenance of the property. JVS Enterprises coordinates finishing-related works with attention to sequence, surface preparation, practical detailing, and final handover quality.",
    included: [
      "Flooring and tiling",
    ...
    cta: "Plan Finishing Work",
  },
  {
    id: "renovation",
    navLabel: "Renovation",
    eyebrow: "05 · REPAIR, RENOVATION & SPECIALTY WORKS",
    title: "Repair, Renovation & Specialty Works",
    heading:
      "Repair, rebuild, extend, or improve with the right construction approach.",
    summary:
      "Structural repair, demolition, maintenance, remodelling, fabrication, welding, partial rebuilding, and site preparation.",
    body:
      "Older structures often need careful inspection before repair or renovation begins. Cracks, leakage, weak plaster, old foundations, drainage issues, and structural changes must be evaluated properly before deciding whether to repair, extend, demolish, or rebuild. JVS Enterprises undertakes renovation, remodelling, demolition, maintenance, repair, fabrication, and welding works based on practical site requirements.",
    included: [
  ...
  },
  {
    ...
    eyebrow: "06 · SITE DEVELOPMENT & EXTERNAL WORKS",
    title: "Site Development & External Works",
    heading: "The work outside the building is often what protects the building.",
    summary:
    ...
    body:
      "A property is not complete with the main structure alone. Drainage, gutters, compound walls, gates, access roads, paver blocks, pavements, sports grounds, and external development decide how the site performs during daily use and monsoon conditions. JVS Enterprises undertakes external development work for residential, institutional, farmhouse, and commercial sites.",
    included: [
      "RCC road work",
      "Pavement work",
      "Paver block work",
...
export const insights = [
  {
    slug: "choosing-construction-company-kolhapur",
    title:
      "Choosing the Right Construction Company in Kolhapur: A Practical Guide for Homeowners and Institutions",
    shortTitle: "Choosing the Right Construction Company in Kolhapur",
    ...
    intro:
      "Choosing a construction company is not only about finding the lowest estimate. A building depends on planning, RCC quality, supervision, material coordination, waterproofing, finishing, drainage, and the contractor’s ability to communicate clearly throughout the project. For homeowners, institutions, and commercial clients in Kolhapur, the right contractor should bring both technical execution and practical site responsibility.",
  },
  {
    slug: "building-in-panhala-landowner-guide",
    title:
      "Building in Panhala: What Every Landowner Should Know Before Starting Construction",
    shortTitle: "Building in Panhala: What Every Landowner Should Know",
    category: "Panhala & Kolhapur",
  ...
  {
    slug: "residential-construction-kolhapur",
    title:
  ...
  {
    slug: "farmhouse-construction-panhala-kolhapur",
    title:
  ...
  {
    slug: "institutional-construction-builder-expectations",
    title:
  ...
  {
    slug: "compound-wall-construction-kolhapur",
    title:
  ...
  {
    slug: "rcc-water-tank-construction",
    title: "Water Tank Construction: What Matters in RCC Water Storage Structures",
    category: "RCC & Structural Work",
    readingTime: "4 minutes",
    excerpt:
  ...
  {
    slug: "sports-ground-external-development",
    title:
  ...
  {
    slug: "renovation-remodelling-kolhapur",
    title:
  ...
  {
    slug: "construction-budgeting-boq-estimation",
    title:
  ...
  {
    slug: "site-supervision-construction-quality",
    title: "The Importance of Site Supervision in Construction Quality",
    category: "Construction Guides",
    readingTime: "4 minutes",
    excerpt:
  ...
  {
    slug: "drainage-gutters-site-development",
    title:
  ...
  {
    slug: "commercial-construction-kolhapur",
    title:
  ...
  {
    slug: "turnkey-construction-projects",
    title:
  ...
  {
    slug: "construction-journey-from-panhala",
    title:
  ...
  {
    slug: "project-note-yspm-nursing-college",
    title:
